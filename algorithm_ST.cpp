...
int score01(minimax_Board board_minimax, const char &color, const char &another_color);
int score02(minimax_Board board_minimax, const char &color, const char &another_color);
int score03(minimax_Board board_minimax, const char &color, const char &another_color);
...
void algorithm_A(Board board, Player player, int index[]){
    ...
    if (orb_num <= 20)
        ...
        position = minimax(board_minimax, 4, 4, true, color, another_color, alpha, beta, 2);
    else 
        position = minimax(board_minimax, 5, 5, true, color, another_color, alpha, beta, 3);
    index[0] = position / 10;
    index[1] = position % 10;
...
int minimax(minimax_Board board_minimax, int first_depth, int depth, bool maxplayer, char color, char another_color, int alpha, int beta, int method) {
    ...
    if (depth == 0 || endgame(board_minimax)) {
        if (method == 1)
            return score01(board_minimax, color, another_color);
        else if (method == 2)
            return score02(board_minimax, color, another_color);
        else 
            return score03(board_minimax, color, another_color);
    }
